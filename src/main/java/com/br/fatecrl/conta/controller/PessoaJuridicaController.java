...
public class PessoaJuridicaController implements IController<PessoaJuridica>{
    ...
    @Override
    @PostMapping
    @Operation(summary = "Cria uma conta de pessoa fisica")
    ...
    @Override
    @PutMapping
    @Operation(summary = "Atualiza uma conta de pessoa fisica")
    ...
    @Operation(summary = "Exclui uma conta de pessoa fisica")
